...
module InstructionDecode(instruction,funct7,rs2,rs1,funct3,rd,opcode,imm,RType);
    ...
    always @ * begin
       ...
       //I Type
       else if((instruction[6:2] == 5'b00_000) || (instruction[6:2] == 5'b00_001) || (instruction[6:2] == 5'b00_100) || (instruction[6:2] == 5'b00_110) || (instruction[6:2] == 5'b11_001))begin
            rd <= instruction[11:7];
            funct3 <= instruction[14:12];
            rs1 <= instruction[19:15];
       ...
       //S Type
       else if((instruction[6:2] == 5'b01_000) || (instruction[6:2] == 5'b01_001)) begin
            funct3 <= instruction[14:12];
            rs1 <= instruction[19:15];
            rs2 <= instruction[24:20];
       ...
       //U Type
       else if((instruction[6:2] == 5'b00_101) || (instruction[6:2] == 5'b01_101)) begin
            rd <= instruction[11:7];
       ...
       //J Type
       else if(instruction[6:2] == 5'b11_011) begin 
            rd <= instruction[11:7];
       ...
       //B Type
      else if(instruction[6:2] == 5'b11_000) begin
        funct3 <= instruction[14:12];
        rs1 <= instruction[19:15];
        rs2 <= instruction[24:20];
        funct7 <= instruction[31:25];
