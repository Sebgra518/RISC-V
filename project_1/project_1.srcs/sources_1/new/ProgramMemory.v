...
module ProgramMemory(address, programOut);
    ...
    always @(*) begin
        case (address)
           32'd0:  programOut = 32'b00000000001100000000010100010011; //li a0, 3
           32'd1:  programOut = 32'b00000000010100000000010110010011; //li a1, 5
           32'd2:  programOut = 32'b00000000101101010000010100110011; //add a0, a0, a1
